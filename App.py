...
for device in deviceList:
   ...
   for ip in iplist:
      netflixFlow = "{\"dpid\": %s, \"table_id\": 0, \"idle_timeout\": 0, \"hard_timeout\": 0, \"priority\": 2, \"flags\": 1, \"match\":{ \"ipv4_src\": \"%s\",  \"eth_type\": 2048, \"in_port\":1 }, \"actions\":[ { \"type\":\"OUTPUT\", \"port\": 4 },  { \"type\":\"OUTPUT\", \"port\": 2 } ] }" % (device, ip)
